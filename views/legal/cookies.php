...
<main class="wrap">
    ...
    <span class="mr-5 ml-5 mb-2 text-info">Actulizado el 2021-12-9</span>
    ...
    Cookies de sesión: diseñadas para recabar y almacenar datos mientras el usuario accede a una página web. <br><br><br>Se suelen emplear para almacenar información que solo interesa conservar para la prestación del servicio solicitado por el usuario en una sola ocasión (p.e. una lista de productos adquiridos).
    ...
    Desactivación y eliminación de cookies.<br><br><br>
